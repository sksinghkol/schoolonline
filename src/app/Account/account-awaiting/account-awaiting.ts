...
@Component({
  selector: 'app-account-awaiting',
  imports: [CommonModule],
  templateUrl: './account-awaiting.html',
  styleUrl: './account-awaiting.scss'
})
export class AccountAwaiting implements OnInit {
  ...
  async ngOnInit() {
    this.route.queryParamMap.subscribe(async (params) => {
      ...
      try {
        const ref = doc(this.firestore, `schools/${schoolId}/accounts/${accountId}`);
